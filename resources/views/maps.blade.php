...
// var markers=L.marker([{{$datas->Tikor_ODP}}],{icon:myIcon})
// .addTo(map)
// .bindPopup("<table><tr><td>Nama </td><td>:</td><td>{{$datas->Nama_ODP}}</td></tr><tr><td>Titik Koordinat</td><td>:</td><td>{{$datas->Tikor_ODP}}</td></tr></td></tr><tr><td>Port</td><td>:</td><td>{{$datas->Port}}</td></tr></td></tr><tr><td>Idle</td><td>:</td><td>{{$datas->Idle}}</td></tr></table>");
// @endforeach
